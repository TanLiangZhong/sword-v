...
export default {
  ...
  data() {
    ...
    return {
      ...
      img: undefined,
      loginRules: {
        username: [{ required: true, trigger: 'blur', message: '请输入帐号', validator: validateUsername }],
  ...
  methods: {
    ...
    codeMaker() {
      this.$store.dispatch('user/getCaptcha').then(response => {
        this.img = response.captcha
      })
    }
  }
}
...
<style lang="scss" scoped>
  ...
  .login-container {
    ...
    background-image: url(~@/assets/bj/login_bj.jpg);
    overflow: hidden;
